        ...
        try:
            if action == "category_save":
                ...
                if item_id:
                    ...
                    await db.execute("INSERT INTO mini_app_materials(title,short_description,full_description,cover_url,telegram_url,category_id,format,status,sort_order,created_at,updated_at) VALUES(?,?,?,?,?,?,?,?,?,?,?)", (*values, now))
