...
class LearningAdmin:
    ...
    async def article_editor(self, request: web.Request) -> web.Response:
        ...
        return web.Response(text=f'''<!doctype html><html lang="ru"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>{title} — Nastaunik</title><script defer src="/mini-app/static/admin_uploads.js?v=1"></script><script defer src="/mini-app/static/admin_material.js?v=8"></script><style>
